...
namespace CursoMVC.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,CategoriaId,Quantidade")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,CategoriaId,Quantidade")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
